...
import TabdashSt from './TabdashSt';
...
class DashboardStudent1 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <Container style={{ flex: 10 }}>
                <HeaderTop pagename={i18n.t("Dashboard")} navigation={this.props.navigation} />
                <ImageBackground
...
export default withTranslation()(DashboardStudent1)
